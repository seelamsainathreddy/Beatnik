...
function LoginForm({ onError }) {
  ...
  return (
    <section class="bg-white dark:bg-gray-900">
        <div class="max-container flex  justify-center min-h-fit px-6 mx-auto my-40">
            <form class="w-1/2">
                ...
                <div class="mt-6">
                    <button class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-coral-red rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                        Sign in
                    </button>
                    ...
                    <div class="mt-6 text-center ">
                        <a href="#/register" class="text-sm text-coral-red hover:underline dark:text-coral-red">
